	...
	resources: {
		en: {
			translation: {
				...
				about: "About",
				aboutContent: `Kapta Mobile is a Progressive Web App to create WhatsApp Maps in 3 steps. <br><br>Why Kapta?<br><br>To connect users and producers of ground information. See our latest blog and where this started in 2010:<br><li><a href='${whatsappMapsUrl}'>WhatsApp Maps? Connecting users and producers of ground information</a></li><br><li><a href='${extremeCitizenUrl}'>Extreme Citizen Science in the Congo rainforest</a></li><br> <br><br>What's next?<br><br>Kapta:A (de)centralised crowdsourcing system to connect users and producers of ground information.`,
				people: "People",
		...
		es: {
			translation: {
				...
				about: "Qué es Kapta?",
				aboutContent: `Kapta Mobile es una app para crear WhatsApp Maps en 3 pasos. <br><br>¿Por qué Kapta?<br><br>Para popularizar el mapeo y conectar usuarios y productores de información de campo. Consulta nuestro último blog y dónde empezó esto en 2010:<br><li><a href='${whatsappMapsUrlSpanish}'>¿WhatsApp Maps? Conectando usuarios y productores de información de campo</a></li><br><li><a href='${extremeCitizenUrl}'>Ciencia Ciudadana Extrema en la selva tropical del Congo</a></li><br> <br><br>Qué sigue?<br><br>Kapta: Un sistema (des)centralizado de crowdsourcing para conectar a usuarios y productores de información de terreno.`,
		...
		fr: {
			translation: {
				...
				about: "À propos",
				aboutContent: `Kapta Mobile est une application web progressive pour créer des Cartes WhatsApp en 3 étapes. <br>Pourquoi?<br>Pour connecter les utilisateurs et les producteurs d'informations de terrain. Consultez notre dernier blog et découvrez où tout a commencé en 2010:<br><li><a href='${whatsappMapsUrl}'>Cartes WhatsApp ? Connecter utilisateurs et producteurs d'informations de terrain</a></li><br><li><a href='${extremeCitizenUrl}'>Science Citoyenne Extrême dans la forêt tropicale du Congo</a></li><br>Kapta : Un système de crowdsourcing (dé)centralisé pour connecter les utilisateurs et les producteurs d'informations sur le terrain.`,
				people: "Personnes",
		...
		am: {
			translation: {
				...
				about: "ስለ",
				aboutContent: `Kapta ሞባይል ሶፍትዌር የእንቅስቃሴ ድህረ-ገጽ (Progressive Web App) ነው። በ3 ሰለስተኛ ደረጃዎች የWhatsApp ካርታዎችን ለመፍጠር ይህን ይጠቀሙ።<br>ለምን?<br>ተጠቃሚዎችንና ባህርይ መረጃ እንደ ስርዓተ-አቀጣጠር በሚፈጸም ሂደት በመሳተፍ ይጠናቀቃል። ያንንም በውስጥ ካልተጠቀሙ ምልክቶች ይኸው:<br><li><a href='${whatsappMapsUrl}'>WhatsApp ካርታዎች? ተጠቃሚዎችንና ባህርይ መረጃ አቅራቢዎችን በማገናኘት</a></li><br><li><a href='${extremeCitizenUrl}'>አበሻ ሲቲዘን ሳይንስ በኮንጎ የዱር ጫካ</a></li><br>ካፕታ: እንደሆነ ተመሳሳይ እንደሆነ የአምባገኝ ስርዓት ተጠቃሚዎችን እና የመሬት መረጃ አምራቾችን ለማገናኘት ።`,
				people: "ሰዎች",
		...
		yo: {
			translation: {
				...
				about: "Nipa",
				aboutContent: `Kapta Mobile jẹ Progressive Web App lati ṣẹda Awọn Maapu WhatsApp ni awọn igbesẹ mẹta. <br>Kí nìdí?<br>Lati so awọn olumulo ati awọn olupilẹṣẹ alaye ilẹ-aye pọ. Wo bulọọgi tuntun wa ati ibi ti eyi ti bẹrẹ ni ọdun 2010:<br><li><a href='${whatsappMapsUrl}'>Awọn Maapu WhatsApp? Ṣiṣepọ awọn olumulo ati awọn olupilẹṣẹ alaye ilẹ-aye</a></li><br><li><a href='${extremeCitizenUrl}'>Ẹkọ Citizens Extreme ni igbó Congo</a></li><br>Kapta: Eto (a)lakanṣe afowopamọwọ lati so awọn olumulo ati awọn olupilẹṣẹ alaye ilẹ pọ.`,
				people: "Àwọn Ènìyàn",
