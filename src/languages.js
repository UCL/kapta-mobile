	...
	resources: {
		en: {
			translation: {
				...
				desktoporiosPrompt:"Kapta works best on Android mobile devices. Please visit this page on an Android mobile device to use the app.",
				install: "Install",
				dismiss: "Dismiss",
			},
		},
		es: {
			translation: {
				...
				updateDescription: "Cambia el título del mapa",
				copyright: "Kapta by UCL",
				supportOption: "Obtenga apoyo para mejorar su mapa",
				installPrompt:"Install Kapta to create WhatsApp Maps",
				desktoporiosPrompt:"Kapta works best on Android mobile devices. Please visit this page on a mobile device to use the app.",
				install: "Instalar",
				dismiss: "No Instalar",
			},
		},
		fr: {
			translation: {
                ...
                copyright: "Kapta by UCL",
                supportOption: "Bénéficier d'un soutien pour améliorer votre carte",
				installPrompt:"Install Kapta to create WhatsApp Maps",
				desktoporiosPrompt:"Kapta works best on Android mobile devices. Please visit this page on a mobile device to use the app.",
                install: "Installer",
                dismiss: "Rejeter",
		...
		am: {
			translation: {
				...
				instructions: `<span class="title">ካፕታ እንዴት እንደሚጠቀሙ</span><hr>1 - በ WhatsApp ቡድን ውስጥ ቦታዎችን ያጋሩ<br>2 - ወደ ካፕታ ሞባይል መተግበሪያ 'ቻት ላክ' የሚለውን ጠቅ ያድርጉ<br>3 - የ WhatsApp ካርታዎን በካፕታይጠቀሙ እና ያካፍሉ።`,
